...
namespace Final_Project
{
    class Map
    {
        ...
        /// <summary>
        /// Fills a 2D array of images with the map for the game
        /// </summary>
        private void FillMap()
        {
            ...
            area[2, 4] = Properties.Resources.TorchRoom;
        }
                ...
                if (story.CheckDoor(xy, dir))
                {
                    ...
                    if (dir == 1)
                    {
                        if (xy.X == 1)
                        {
                            ...
                            {
                                form.TxtBox.Text = "You can't move that way.";
                            }
                        }
                        else
                        {
                    ...
                    else if (dir == 2)
                    {
                        ...
                        else if (xy.Y == 8)
                        {
                            if (xy.X == 1)
                            {
                                if (!story.enteredMaze && !Array.Exists(story.Inventory, element => element.ID == 3))
                                    story.Dialog(xy);
                                else
                                {
                                    story.Maze = true;
        ...
        /// <summary>
        /// Updates the map so that the player can see where they've been
        /// </summary>
        /// <param name="xy"> Current XY Coordinates </param>
        private void UpdateMap(Point xy)
        {
            ...
            }else if(xy.X == 2)
            {
                ...
                {
                    MapSetting[2, 4] = 2;
                    mapForm.PB24.Image = Properties.Resources.TorchRoom;
                }
                else if (xy.Y == 8)
                {
                    MapSetting[2, 8] = 2;
        ...
        /// <summary>
        /// Handles the Maze the player goes through
        /// </summary>
        /// <param name="dir"> The direction the player chose </param>
        /// <returns></returns>
